...
func helloHandler(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintln(w, "Welcome to the Safari server")
}
...
func getProduct(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Access-Control-Allow-Origin", "*") // Reason of CORS Effor: as if can access for everywhere origin.
...
func createProduct(w http.ResponseWriter, r *http.Request) {
	...
	//fmt.Println("Incoming method:", r.Method) // just to know what does mathod came from the frontend.
...
func main() {
	...
	mux.HandleFunc("/hey", helloHandler)
...
/*
   This is actually came by GET method from frontend.

   newProduct.ID = len(ProductList) + 1 // 	Length বাড়ানো হচ্ছে না ❌.Slice এ product add করার আগে শুধু নতুন ID assign করা হচ্ছে ✅
*/
